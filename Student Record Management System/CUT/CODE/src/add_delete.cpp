...
Student::Student()
{
        ...
        stream = " ";
        age = " ";
        roll_no = physics = chemistry = biology = maths = english = electronics = computers = total_marks = 0;
        phone_no = " ";
        percentage = 0;
}
...
Student::Student(string name,int roll_no,string email_id,string phone_no,string age,string gender,string address,string stream,int physics,int chemistry,int maths,int biology,int computers,int electronics,int english,int total_marks,float percentage)
{
        this->name = name;
